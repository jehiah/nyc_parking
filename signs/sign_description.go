...
var descReplacer = strings.NewReplacer(
	...
	"(VOID SEE R7-28R)", "(SUPERSEDED BY R7-28R)",
	"(VOIDED) USE PS-31GA", "(SUPERSEDED BY PS-31GA)",
	"(VOIDED) USE PS-31G", "(SUPERSEDED BY PS-31G)",
	// "(VOIDED) USE ", "SUPERSEDED BY ",
	// "(VOID SEE ", " SUPERSEDED BY ",
	// ")VOIDED USE ", " SUPERSEDED BY ",
